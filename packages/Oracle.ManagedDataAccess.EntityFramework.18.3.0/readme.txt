Oracle.ManagedDataAccess.EntityFramework Nuget Package Version 18.3.0 README
============================================================================
...
New Features since Oracle.ManagedDataAccess.EntityFramework Nuget Package Version 12.2.1100
===========================================================================================
None
...
1. Un-GAC any existing ODP.NET for Entity Framework 18.3 versions you have installed. For example, if you 
plan to use only the ODP.NET, Managed Driver for Entity Framework, only un-GAC existing managed ODP.NET for
Entity Framework 18.3 versions then.
